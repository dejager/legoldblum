...
* mobile device.
* Progam your own shader function in `lifeUhFindsAWay` in Uh.metal.
...
do {
  let path = Bundle.main.path(forResource: "MommysVeryAngry", ofType: "metal")
...
renderer.functionName = "lifeUhFindsAWay"
